...
export function DemoResults() {
  ...
  const getSummaryForSearch = (search: string) => {
    const summaries: Record<string, string> = {
      "CEOs in Texas": "Found 2 CEOs in Texas tech companies. Both are in major cities with strong startup ecosystems. Consider reaching out to Sarah Chen first - her company is in a similar space.",
      "engineers who know Python": "Identified 2 Python engineers across different specialties. Maria Silva has ML expertise which might be valuable for AI projects.",
      "marketing experts in NYC": "Located 2 senior marketing professionals in NYC. Emma Thompson's CMO experience could provide strategic insights.",
      "founders I met last year": "Retrieved 2 founders from your 2023 connections. Chris Anderson's company has grown significantly since you met.",
      "investors in fintech": "Found 2 fintech investors with different check sizes. Patricia Johnson focuses on Series A rounds."
    };
